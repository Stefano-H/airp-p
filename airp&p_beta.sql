CREATE DATABASE AlquilaTuEvento;

USE AlquilaTuEvento;

CREATE TABLE IF NOT EXISTS `AlquilaTuEvento`.`listings` (
...
CREATE TABLE IF NOT EXISTS `AlquilaTuEvento`.`direccion` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `direccion_ibfk_1`
    FOREIGN KEY (`id`)
    REFERENCES `AlquilaTuEvento`.`listings` (`id`)
) ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
ROW_FORMAT = DYNAMIC;

CREATE TABLE IF NOT EXISTS `AlquilaTuEvento`.`categorias` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `AlquilaTuEvento`.`servicios` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `AlquilaTuEvento`.`propietario` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `AlquilaTuEvento`.`ordenes` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `AlquilaTuEvento`.`usuarios` (
  ...
  `fotocara` VARCHAR(255) DEFAULT NULL,
...
INSERT INTO `AlquilaTuEvento`.`propietario` (`id`, `foto_url`, `id_usuario`, `nombre_propietario`, `fecha_de_creación_de_cuenta`, `verificado`) VALUES ('1', 'https://a0.muscache.com/im/pictures/miso/Hosting-45306806/original/2c52733a-78b3-421d-a49a-bea959ab86da.jpeg', ' ', 'Marcos', '27/01/2025', '0');
...
INSERT INTO `AlquilaTuEvento`.`propietario` (`id`, `foto_url`, `id_usuario`, `nombre_propietario`, `fecha_de_creación_de_cuenta`, `verificado`) VALUES ('2', 'https://a0.muscache.com/im/pictures/miso/Hosting-45306806/original/2c52733a-78b3-421d-a49a-bea959ab86da.jpeg', ' ', 'Marcos', '27/01/2025', '0');
...
INSERT INTO `AlquilaTuEvento`.`propietario` (`id`, `foto_url`, `id_usuario`, `nombre_propietario`, `fecha_de_creación_de_cuenta`, `verificado`) VALUES 
